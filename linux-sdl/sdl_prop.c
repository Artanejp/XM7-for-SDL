 ...
 */
    ...
    GtkWidget   *frmFMVolume;
    GtkWidget   *lblFMVolume;

    GtkWidget   *frmPSGVolume;
    GtkWidget   *lblPSGVolume;

    GtkWidget   *frmBEEPVolume;
    GtkWidget   *lblBEEPVolume;

    GtkWidget   *frmTAPEVolume;
    GtkWidget   *lblTAPEVolume;

    GtkWidget   *frmWAVVolume;
    GtkWidget   *lblWAVVolume;

    //GtkWidget   *scaleFMVolume; /* -96 - +10 */
    //GtkWidget   *scalePSGVolume; /* -96 - +10 */
    //GtkWidget   *scaleBeepVolume; /* -96 - 0 */
    //GtkWidget   *scaleCMTVolume; /* -96 - 0 */
    //GtkWidget   *scaleWAVEVolume; /* -96 - 0 */
    GtkWidget   *lblVolume;
/*
 * Cancel,OK 
 */
 ...
 */
    ...
    gtk_box_pack_start(GTK_BOX(hbox3), GP_AUTOSPEEDADJUST, 
                       TRUE, FALSE, 0);
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet),0),
                               lblGeneral);
/*
 * Page 1 
 */
 ...
 */
...
#ifdef FDDSND
    SP_FDDSOUND =
            gtk_check_button_new_with_mnemonic("FDDシーク音/CMTリレー音");
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet), 1),
                               lblSound);
 ...
 */
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet), 3),
                               lblJoyStick1);
 ...
 */
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet),4),
                               lblJoyStick2);
 ...
 */
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet),5),
                               lblScreen2);
    ...
    OP_MOUSE_PORT1 =
	gtk_radio_button_new_with_mnemonic(NULL, "ポート1にマウスを接続");
    ...
    OP_MOUSE_PORT2 =
	gtk_radio_button_new_with_mnemonic(NULL, "ポート2にマウスを接続");
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet),
                                                         6), lblOption);
 ...
 */
    ...
    gtk_container_add(GTK_CONTAINER(propertySheet), vbox40);
    gtk_container_set_border_width(GTK_CONTAINER(vbox40), 4);
    hbox50 = gtk_hbox_new(FALSE, 8);
    gtk_widget_show(hbox50);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox50);
    gtk_container_set_border_width(GTK_CONTAINER(hbox50), 4);


    hbox51 = gtk_hbox_new(FALSE, 4);
    gtk_widget_show(hbox51);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox51);
    gtk_container_set_border_width(GTK_CONTAINER(hbox51), 4);

    frmFMVolume = gtk_frame_new(NULL);
    gtk_widget_show(frmFMVolume);
    gtk_container_add(GTK_CONTAINER(hbox51), frmFMVolume);
    gtk_container_set_border_width(GTK_CONTAINER(frmFMVolume), 1);
    ...
    gtk_frame_set_label_widget(GTK_FRAME(frmFMVolume), lblFMVolume);
    gtk_label_set_justify(GTK_LABEL(lblFMVolume), GTK_JUSTIFY_LEFT);

    hbox52 = gtk_hbox_new(FALSE, 4);
    gtk_widget_show(hbox52);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox52);
    gtk_container_set_border_width(GTK_CONTAINER(hbox52), 4);

    frmPSGVolume = gtk_frame_new(NULL);
    gtk_widget_show(frmPSGVolume);
    gtk_container_add(GTK_CONTAINER(hbox52), frmPSGVolume);
    ...
    gtk_label_set_justify(GTK_LABEL(lblPSGVolume), GTK_JUSTIFY_LEFT);

    hbox53 = gtk_hbox_new(FALSE, 4);
    gtk_widget_show(hbox53);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox53);
    gtk_container_set_border_width(GTK_CONTAINER(hbox53), 4);

    frmBEEPVolume = gtk_frame_new(NULL);
    gtk_widget_show(frmBEEPVolume);
    gtk_container_add(GTK_CONTAINER(hbox53), frmBEEPVolume);
    ...
    gtk_frame_set_label_widget(GTK_FRAME(frmBEEPVolume), lblBEEPVolume);
    gtk_label_set_justify(GTK_LABEL(lblBEEPVolume), GTK_JUSTIFY_LEFT);

    hbox54 = gtk_hbox_new(FALSE, 4);
    gtk_widget_show(hbox54);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox54);
    gtk_container_set_border_width(GTK_CONTAINER(hbox54), 4);

    frmTAPEVolume = gtk_frame_new(NULL);
    gtk_widget_show(frmTAPEVolume);
    gtk_container_add(GTK_CONTAINER(hbox54), frmTAPEVolume);
    ...
    gtk_frame_set_label_widget(GTK_FRAME(frmTAPEVolume), lblTAPEVolume);
    gtk_label_set_justify(GTK_LABEL(lblTAPEVolume), GTK_JUSTIFY_LEFT);

    hbox55 = gtk_hbox_new(FALSE, 4);
    gtk_widget_show(hbox55);
    gtk_container_add(GTK_CONTAINER(vbox40), hbox55);
    gtk_container_set_border_width(GTK_CONTAINER(hbox55), 4);
#ifdef FDDSND
    frmWAVVolume = gtk_frame_new(NULL);
    gtk_widget_show(frmWAVVolume);
    gtk_container_add(GTK_CONTAINER(hbox55), frmWAVVolume);
    ...
    gtk_widget_show(lblWAVVolume);
    gtk_frame_set_label_widget(GTK_FRAME(frmWAVVolume), lblWAVVolume);
    gtk_label_set_justify(GTK_LABEL(lblWAVVolume), GTK_JUSTIFY_LEFT);
#endif
 ...
 */
    ...
    //gtk_container_add(GTK_CONTAINER(hbox50), vbox46);
    //gtk_container_set_border_width(GTK_CONTAINER(vbox46), 4);

    lblVolume = gtk_label_new("個別音量");
    gtk_widget_show(lblVolume);
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(propertySheet),
                               gtk_notebook_get_nth_page(GTK_NOTEBOOK(propertySheet), 7),
                               lblVolume);
    gtk_label_set_justify(GTK_LABEL(lblVolume), GTK_JUSTIFY_LEFT);
 ...
 */
    ...
    gtk_signal_connect_object((gpointer) btnCancel, "clicked",
				 GTK_SIGNAL_FUNC(gtk_widget_destroy),
				 (gpointer) winProperty);
    gtk_signal_connect_object((gpointer) btnOk, "clicked",
				GTK_SIGNAL_FUNC(gtk_widget_destroy),
				(gpointer) winProperty);
    return winProperty;
}
