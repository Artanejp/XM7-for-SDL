...
static void FASTCALL CreateFileMenu 
	 ...
	 */ 
	sub_item =
	gtk_menu_item_new_with_label("名前を付けて別名保存");
	 ...
	 */ 
	sub_item =
	gtk_radio_menu_item_new_with_label(ModeGroup, "BASICモード");
	 ...
	 */ 
	sub_item =
	gtk_radio_menu_item_new_with_label(ModeGroup, "DOSモード");
...
static void FASTCALL CreateDiskMenu 
	 ...
	 */ 
	midrive_openboth[d] =
	gtk_menu_item_new_with_label("両ドライブで開く");
	 ...
	 */ 
	midrive_teject[d] =
	gtk_check_menu_item_new_with_label("一時取り出し");
	 ...
	 */ 
	midrive_writep[d] =
	gtk_check_menu_item_new_with_label("書き込み禁止");
	 ...
	 */ 
	gtk_menu_item_set_submenu(GTK_MENU_ITEM(drive_item[d]),
				  drive_menu[d]);
...
static void FASTCALL CreateToolMenu 
	 ...
	 */ 
	miMouseCapture =
	gtk_check_menu_item_new_with_label("マウスモード");
	 ...
	 */ 
	sub_item =
	gtk_menu_item_new_with_label("縮小画像キャプチャ");
	 ...
	 */ 
	miWavCapture =
	gtk_check_menu_item_new_with_label("WAVキャプチャ");
	 ...
	 */ 
	sub_item =
	gtk_menu_item_new_with_label("新規ディスク作成");
