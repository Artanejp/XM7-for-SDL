 ...
 */
static BOOL FASTCALL bmp_palette_sub(int fileh)
{
	int i;
	BYTE *p;
	int vpage;
 ...
 */
#if XM7_VER >= 2
static BOOL FASTCALL bmp_320_sub(int fileh, BOOL fullscan)
{
	int x, y;
	int offset;
	int i;
 ...
 */
#if XM7_VER >= 2
static BOOL FASTCALL bmp_320_sub2(int fileh)
{
	int x, y;
	int offset;
	int i;
 ...
 */
static BOOL FASTCALL bmp_640_sub2(int fileh)
{
	int x, y;
	int i;
	int offset;
 ...
 */
static BOOL FASTCALL bmp_400l4_sub2(int fileh)
{
	int x, y;
	int i;
	int offset;
