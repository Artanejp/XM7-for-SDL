...
#ARCH_FLAGS       = -mmmx -msse -msse2 -march=amdfam10
...
CFLAGS = -DXM7_VER=$(XM7_VER) $(OPTION) -DRSSDIR=\"$(SHAREDIR)\"
...
#CFLAGS += `/bin/sdl-config --cflags`
CFLAGS += -I/mingw/include
CFLAGS += -I/mingw/include/SDL
CFLAGS += -I/mingw/include/freetype2
CFLAGS += -I/mingw/include/agar
#CFLAGS += `/usr/local/i686-w64-mingw32/bin/agar-config --cflags`
# OpenMP
ifdef USE_OPENMP
CFLAGS += -fopenmp
endif
