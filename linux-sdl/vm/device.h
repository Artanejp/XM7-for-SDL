...
extern          "C" {
     ...
     */
    BOOL file_byte_read(SDL_RWops *handle, BYTE * dat);
    /*
     * バイト読み込み
     */
    BOOL FASTCALL   file_word_read(SDL_RWops *handle, WORD * dat);
    /*
     * ワード読み込み
     */
    BOOL file_dword_read(SDL_RWops *handle, DWORD * dat);
    /*
     * ダブルワード読み込み
     */
    BOOL file_bool_read(SDL_RWops *handle, BOOL * dat);
    /*
     * ブール読み込み
     */
    BOOL file_byte_write(SDL_RWops *handle, BYTE dat);
    /*
     * バイト書き込み
     */
    BOOL file_word_write(SDL_RWops *handle, WORD dat);
    /*
     * ワード書き込み
     */
    BOOL file_dword_write(SDL_RWops *handle, DWORD dat);
    /*
     * ダブルワード書き込み
     */
    BOOL file_bool_write(SDL_RWops *handle, BOOL dat);
    /*
     * ブール書き込み
     */
#ifdef __cplusplus
