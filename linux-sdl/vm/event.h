...
#define EVENT_FDC_M				14	/* FDC
							 * マルチセクタ 
							 */
#define EVENT_FDC_L				15	/* FDC
							 * ロストデータ 
							 */
...
#define	EVENT_RS_TXTIMING		21	/* RS-232C
						 * 送信タイミング */
#define	EVENT_RS_RXTIMING		22	/* RS-232C
						 * 受信タイミング */
