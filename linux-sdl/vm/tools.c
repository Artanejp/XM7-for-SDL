 ...
 *      ブランクディスク作成 サブ
 */
static BOOL FASTCALL make_d77_sub(SDL_RWops * fileh, DWORD dat)
{
	BYTE buf[4];
 ...
 *      １バイト出力
 */
static BOOL FASTCALL vtp_conv_write(SDL_RWops * handle, BYTE dat)
{
	int i;
	BYTE buf[44];
 ...
 *      BMPヘッダ書き込み
 */
static BOOL FASTCALL bmp_header_sub(SDL_RWops * fileh)
{
	BYTE filehdr[14];
	BYTE infohdr[40];
 ...
 *      BMPヘッダ書き込み (縮小画像用)
 */
static BOOL FASTCALL bmp_header_sub2(SDL_RWops * fileh)
{
	BYTE filehdr[14];
	BYTE infohdr[40];
 ...
 */
static BOOL FASTCALL bmp_palette_sub(SDL_RWops * fileh)
{
	int i;
	BYTE *p;
	int vpage;
 ...
 */
#if XM7_VER >= 2
static BOOL FASTCALL bmp_320_sub(SDL_RWops * fileh, BOOL fullscan)
{
	int x, y;
	int offset;
	int i;
 ...
 *  BMPデータ書き込み(26万色モード)
 */
static BOOL FASTCALL bmp_256k_sub(SDL_RWops * fileh, BOOL fullscan)
{
	int x, y;
	int offset;
	int i;
 ...
 *  BMPデータ書き込み(640モード)
 */
static BOOL FASTCALL bmp_640_sub(SDL_RWops * fileh, BOOL fullscan)
{
	int x, y;
	int i;
	int offset;
 ...
 */
static BOOL FASTCALL bmp_400l_sub(SDL_RWops * fileh)
{
	int x, y;
	int i;
	int offset;
 ...
 */
static BOOL FASTCALL bmp_400l4_sub(int fileh)
{
	int x, y;
	int i;
	int offset;
 ...
 */
#if XM7_VER >= 2
static BOOL FASTCALL bmp_320_sub2(SDL_RWops * fileh)
{
	int x, y;
	int offset;
	int i;
 ...
 */
static BOOL FASTCALL bmp_256k_sub2(SDL_RWops * fileh)
{
	int x, y;
	int offset;
	int i;
 ...
 */
static BOOL FASTCALL bmp_640_sub2(SDL_RWops * fileh)
{
	int x, y;
	int i;
	int offset;
 ...
 */
static BOOL FASTCALL bmp_400l_sub2(SDL_RWops * fileh)
{
	int x, y;
	int i;
	int offset;
 ...
 */
static BOOL FASTCALL bmp_400l4_sub2(SDL_RWops * fileh)
{
	int x, y;
	int i;
	int offset;
