 ...
 *	データロード
 */
static void FASTCALL LoadCfgFile(void)
{
	INI_load();
}
 ...
 *	データセーブ
 */
static void FASTCALL SaveCfgFile(void)
{
	INI_save();
}
...
void FASTCALL LoadCfg(void)
{
	...
	for (i=0; i<5; i++) {
		if (!LoadCfgString((char *)InitDirStr[i], InitialDir[i], MAXPATHLEN)) {
	...
	configdat.uSeekVolume = LoadCfgInt("FDDSeekVolume", 128);
#endif
...
//	}
	...
	configdat.nMidBtnMode = (BYTE)LoadCfgInt("MidBtnMode", MOSCAP_WMESSAGE);
#endif
}
...
void FASTCALL ApplyCfg(void)
{
	...
	uSeekVolume = configdat.uSeekVolume;
#endif
	ApplySnd();
 ...
 *	ダイアログ初期化
 */
static void FASTCALL GeneralPageInit(void)
{
	char string[128];
 ...
 *	適用
 */
static void FASTCALL GeneralPageApply(void)
{
	/* ステート変更 */
	uPropertyState = 2;
 ...
 *	ダイアログ初期化
 */
static void FASTCALL SoundPageInit(void)
{
	char string[128];
 ...
 *	適用
 */
static void FASTCALL SoundPageApply(void)
{
	UINT uPos;
 ...
 *	ダイアログ初期化
 */
static void FASTCALL KbdPageInit(void)
{
	int index;
	int i;
	char string[128];
 ...
 *	適用
 */
static void FASTCALL KbdPageApply(void)
{
	/* ステート変更 */
	uPropertyState = 2;
 ...
 *	ダイアログ初期化
 */
static void FASTCALL ScrPageInit(void)
{
	/* シート初期化 */
	SheetInit();
 ...
 *	適用
 */
static void FASTCALL ScrPageApply(void)
{
	/* ステート変更 */
	uPropertyState = 2;
 ...
 *	ダイアログ初期化
 */
static void FASTCALL OptPageInit(void)
{
	/* シート初期化 */
	SheetInit();
 ...
 *	適用
 */
static void FASTCALL OptPageApply(void)
{
	/* ステート変更 */
	uPropertyState = 2;
