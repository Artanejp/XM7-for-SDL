...
void EmuGrph4096c::GetVram(Uint32 addr, Uint32 *cbuf)
{
        ...
        g[3] = vram_p[addr + 0x10000];
        g[2] = vram_p[addr + 0x12000];
        g[1] = vram_p[addr + 0x14000];
        g[0] = vram_p[addr + 0x16000];

        r[3] = vram_p[addr + 0x08000];
        r[2] = vram_p[addr + 0x0a000];
        r[1] = vram_p[addr + 0x0c000];
        r[0] = vram_p[addr + 0x0e000];

        b[3] = vram_p[addr + 0x00000];
        b[2] = vram_p[addr + 0x02000];
        b[1] = vram_p[addr + 0x04000];
        b[0] = vram_p[addr + 0x06000];
